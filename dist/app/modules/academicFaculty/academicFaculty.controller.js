...
const createFaculty = (0, catchAsync_1.catchAsync)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result =
      yield academicFaculty_service_query_1.academicFacultyService.createFaculty(
        academicFacultyData
      )
...
const getAllFaculties = (0, catchAsync_1.catchAsync)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result =
      yield academicFaculty_service_query_1.academicFacultyService.getAllFaculties(
        filters,
        paginationOptions
      )
    ;(0, sendResponse_1.sendResponse)(res, {
...
const getSingleFaculty = (0, catchAsync_1.catchAsync)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params
    const result =
      yield academicFaculty_service_query_1.academicFacultyService.getSingleFaculty(
        id
      )
    ;(0, sendResponse_1.sendResponse)(res, {
      statusCode: 200,
...
const updateFaculty = (0, catchAsync_1.catchAsync)(
  (0, catchAsync_1.catchAsync)((req, res) =>
    __awaiter(void 0, void 0, void 0, function* () {
      const { id } = req.params
      const updatedData = req.body
      const result =
        yield academicFaculty_service_query_1.academicFacultyService.updateFaculty(
          id,
          updatedData
        )
      ;(0, sendResponse_1.sendResponse)(res, {
...
const deleteFaculty = (0, catchAsync_1.catchAsync)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params
    const result =
      yield academicFaculty_service_query_1.academicFacultyService.deleteByIdFromDB(
        id
      )
    ;(0, sendResponse_1.sendResponse)(res, {
      statusCode: 200,
