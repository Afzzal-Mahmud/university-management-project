...
const createDepartment = (0, catchAsync_1.catchAsync)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield academicDepartment_service_query_1.academicDepartmentService.createDepartment(academicDepartmentData);
...
const getAllDepartments = (0, catchAsync_1.catchAsync)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const filters = (0, pickRequest_1.pickRequest)(req.query, academicDepartmentFilterableFields);
    const paginationOptions = (0, pickRequest_1.pickRequest)(req.query, paginationField_1.paginationFields);
    const result = yield academicDepartment_service_query_1.academicDepartmentService.getAllDepartments(filters, paginationOptions);
    (0, sendResponse_1.sendResponse)(res, {
        statusCode: 200,
        success: true,
...
const getSingleDepartment = (0, catchAsync_1.catchAsync)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
    const result = yield academicDepartment_service_query_1.academicDepartmentService.getSingleDepartment(id);
    (0, sendResponse_1.sendResponse)(res, {
        statusCode: 200,
        success: true,
...
const updateDepartment = (0, catchAsync_1.catchAsync)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
    const result = yield academicDepartment_service_query_1.academicDepartmentService.updateDepartment(id, req.body);
    (0, sendResponse_1.sendResponse)(res, {
        statusCode: 200,
        success: true,
...
const deleteDepartment = (0, catchAsync_1.catchAsync)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
    const result = yield academicDepartment_service_query_1.academicDepartmentService.deleteDepartment(id);
    (0, sendResponse_1.sendResponse)(res, {
        statusCode: 200,
        success: true,
