...
const getAllStudents = (0, catchAsync_1.catchAsync)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield student_service_query_1.studentServices.retriveAllStudents(filters, paginationOptions);
...
const getSingleStudent = (0, catchAsync_1.catchAsync)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield student_service_query_1.studentServices.retriveSingleStudent(id);
    (0, sendResponse_1.sendResponse)(res, {
        statusCode: 200,
        success: true,
...
const updateStudent = (0, catchAsync_1.catchAsync)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield student_service_query_1.studentServices.updateStudentInfo(id, updatedData);
    (0, sendResponse_1.sendResponse)(res, {
        statusCode: 200,
        success: true,
...
const deleteStudent = (0, catchAsync_1.catchAsync)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const id = req.params.id;
    const result = yield student_service_query_1.studentServices.deleteStudent(id);
    (0, sendResponse_1.sendResponse)(res, {
        statusCode: 200,
        success: true,
