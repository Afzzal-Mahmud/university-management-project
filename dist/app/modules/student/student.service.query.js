...
const retriveAllStudents = (filters, paginationOptions) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const { page, limit, skipDoc, sortBy, sortOrder } = (0,
    paginationHelpers_1.calculatePagination)(paginationOptions)
...
const updateStudentInfo = (id, payload) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (payload.guardian) {
      for (const key in guardian) {
        if (Object.prototype.hasOwnProperty.call(guardian, key)) {
          isStudentExist.guardian[key] = guardian[key]
        }
      }
    }
    if (payload.localGuardian) {
      for (const key in localGuardian) {
        if (Object.prototype.hasOwnProperty.call(localGuardian, key)) {
          isStudentExist.localGuardian[key] = localGuardian[key]
        }
      }
    }
