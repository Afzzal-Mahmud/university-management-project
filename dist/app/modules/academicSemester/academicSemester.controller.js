...
const createSemester = (0, catchAsync_1.catchAsync)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield academicSemester_service_query_1.AcademicSemesterService.createAcademicSemester(academicSemesterData);
...
const getSemesters = (0, catchAsync_1.catchAsync)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const paginationOptions = (0, pickRequest_1.pickRequest)(req.query, paginationKeyArray);
    const result = yield academicSemester_service_query_1.AcademicSemesterService.getAllSemesters(filters, paginationOptions);
    (0, sendResponse_1.sendResponse)(res, {
        statusCode: 200,
        success: true,
...
const getSingleSemester = (0, catchAsync_1.catchAsync)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield academicSemester_service_query_1.AcademicSemesterService.retriveSingleSemester(id);
    (0, sendResponse_1.sendResponse)(res, {
        statusCode: 200,
        success: true,
...
const updateSemester = (0, catchAsync_1.catchAsync)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield academicSemester_service_query_1.AcademicSemesterService.updateSemesterInfo(id, updatedData);
    (0, sendResponse_1.sendResponse)(res, {
        statusCode: 200,
        success: true,
...
const deleteSemester = (0, catchAsync_1.catchAsync)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const id = req.params.id;
    const result = yield academicSemester_service_query_1.AcademicSemesterService.deleteSemester(id);
    (0, sendResponse_1.sendResponse)(res, {
        statusCode: 200,
        success: true,
